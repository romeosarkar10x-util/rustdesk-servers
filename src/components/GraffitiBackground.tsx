...
const BLOBS: { style: CSSProperties; dur: number; delay: number }[] = [
    ...
    },
    {
        style: {
            ...
            width: 200,
            height: 200,
            background: "radial-gradient(ellipse at 50% 50%, var(--purple) 0%, transparent 70%)",
            filter: "blur(35px)",
    ...
    },
    {
        style: {
            ...
            width: 180,
            height: 180,
            background: "radial-gradient(ellipse at 50% 50%, var(--lime) 0%, transparent 70%)",
            filter: "blur(25px)",
            transform: "rotate(-5deg)",
        },
        dur: 7,
    ...
    },
    {
        style: {
            ...
            width: 220,
            height: 220,
            background: "radial-gradient(ellipse at 50% 50%, var(--orange) 0%, transparent 70%)",
            filter: "blur(45px)",
        },
        dur: 10,
        delay: 1.8,
